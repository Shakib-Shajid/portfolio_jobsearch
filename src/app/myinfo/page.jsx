    ...
    return (
        <div className='flex w-full'>
            <div className='flex flex-col gap-5 mx-auto border-info rounded-2xl border-2 pt-10 md:p-20 w-96 md:w-[80%] lg:w-[50%]'>
                <h3 className='text-3xl font-bold text-center text-info'>Your Info</h3>

                <form onSubmit={handleCreate} className="flex flex-col gap-5" ref={formRef}>
                    <input type="text" className='input input-info border-2 rounded-xl w-80 md:w-96 mx-auto p-5' placeholder='Name' />
                    <input type="email" className='input input-info border-2 rounded-xl w-80 md:w-96 mx-auto p-5' placeholder='email' />
                    <input type="text" className='input input-info border-2 rounded-xl w-80 md:w-96 mx-auto p-5' placeholder='Current Company Name' />
                    <input type="text" className='input input-info border-2 rounded-xl w-80 md:w-96 mx-auto p-5' placeholder='Current Company Designation' />
                    ...
                    {/* Skill Selector */}
                    <select onChange={handleSkillSelect} defaultValue="My Skills" className="select input-info border-2 rounded-xl w-80 md:w-96 mx-auto text-gray-400">
                    ...
                    <input type="text" className='input input-info border-2 rounded-xl w-80 md:w-96 mx-auto p-5' placeholder='Your Expertice like frontend, backend (Show as title)' />

                    <textarea placeholder="About yourself" className="text-sm textarea textarea-lg input-info border-2 rounded-xl w-80 md:w-96 mx-auto p-5"></textarea>
                    ...
                    <input type="date" className='input input-info border-2 rounded-xl w-80 md:w-96 mx-auto p-5' placeholder='Position Name' />
                    <input type="date" className='input input-info border-2 rounded-xl w-80 md:w-96 mx-auto p-5' placeholder='Position Name' />
